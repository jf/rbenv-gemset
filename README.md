...
*Please consider sponsorship!* I have maintained this project for over a decade now without complaint _(I took over in [July 2013](#history))_... but could do with some support at this juncture in my life. [Thank you](https://github.com/sponsors/jf).
...
If you want to use [Homebrew](https://github.com/Homebrew/brew) (macOS):
